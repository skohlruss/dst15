...
public class ClassifyLectureWrapperDTO implements Serializable {
	...
	public ClassifyLectureWrapperDTO() {
	}

	public ClassifyLectureWrapperDTO(Long id, Long lectureId, LifecycleState state, String classifiedBy,
			LectureType type) {
		super();
		this.id = id;
	...
	public ClassifyLectureWrapperDTO(ILectureWrapper lecture) {
		super();
