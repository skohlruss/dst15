...
public interface IEventStreaming {
	 ...
	 * events of type LectureAssigned, LectureStreamed, LectureDuration, and AvgLectureDuration). 
	 ...
	 * @param lectureWrapper the new Lecture-Wrapper event
	 */
	void addEvent(ILectureWrapper lectureWrapper);
